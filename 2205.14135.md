...
- **Scaling characteristics**: Up to **3×** faster than PyTorch attention for (N\le2)k; memory grows **linearly** with (N) and remains **~20×** lower than exact baselines; supports sequences up to **64k**. (**Fig. 3, p. 9–10**.)
